...
import { AuthState, User, LoginCredentials, RegisterCredentials } from '../../types/index';
import instanceApi from '../../lib/axios';

const initialState: AuthState = {
  user: null,
  isAuthenticated: false, // Will be determined by checkAuth on app load
  loading: false,
  error: null,
};
...
export const logoutUser = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      // Even if logout API fails, continue (backend will clear cookies)
...
export const checkAuth = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      // No need to clear tokens - they are httpOnly cookies managed by backend
